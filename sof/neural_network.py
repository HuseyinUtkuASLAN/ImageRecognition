...
class Dropout(object):
    ...
    def train(self, epochs=5000, dropout=True, p_dropout=0.5, rng=None,lr = 0.1):
        
        for epoch in range(epochs):
            # if(epoch % 20 == 0):
            #     for i,l in enumerate(self.hidden_layers):
            #         self.hidden_layers[i] = l / numpy.linalg.norm(l)
            ...
            for i in reversed(range(0, self.n_layers)):
                ...
                self.hidden_layers[i].backward(prev_layer=prev_layer,lr = lr)
